...
<style>
.hero { display: grid; grid-template-columns: 1.2fr 2fr; gap: 18px; align-items: center; padding: 16px; border: 1px solid #e5e7eb; border-radius: 12px; background: #ffffff; }
...
.badge { display: inline-flex; align-items: center; gap: 8px; padding: 6px 10px; border: 1px solid #e5e7eb; border-radius: 999px; font-size: 13px; color: #111827; background: #f9fafb; text-decoration: none; }
...
<div class="hero">
  ...
  <div>
    ...
    <div class="badges">
      <a class="badge" href="mailto:{{ site.author.email }}">Email</a>
      <a class="badge" href="{{ site.author.uri }}" target="_blank" rel="noopener">Website</a>
      <a class="badge" href="https://github.com/{{ site.author.github }}" target="_blank" rel="noopener">GitHub</a>
      <a class="badge" href="https://www.facebook.com/profile.php?id=100049110682203" target="_blank" rel="noopener">Facebook</a>
    </div>
  </div>
...
<div class="section">
  <h2>Contact</h2>
  <div class="badges">
    <span class="badge">DOB: 20/11/2003</span>
    <span class="badge">Nationality: Burmese (Myanmar)</span>
    <span class="badge">Phone: (+95) 9420053538</span>
    <span class="badge">Viber: 09420053538</span>
    <a class="badge" href="mailto:{{ site.author.email }}">{{ site.author.email }}</a>
    <a class="badge" href="{{ site.author.uri }}" target="_blank" rel="noopener">{{ site.author.uri | replace: 'https://','' }}</a>
    <a class="badge" href="https://www.facebook.com/profile.php?id=100049110682203" target="_blank" rel="noopener">facebook.com/…</a>
    <span class="badge">Address: No.531, Lower Pazundaung Rd, Yangon, 11211</span>
  </div>
</div>
